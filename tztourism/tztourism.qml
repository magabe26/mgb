        ...
        Item {
            ...
            Item {
                ...
                VideoOutput {
                    id: fsVideoOut
                    anchors.fill: parent
                    // Only bind source while fullscreen — avoids stealing
                    // the MediaPlayer from the normal-screen VideoOutput.
                    source: safariTvOverlay.tvFullScreen ? safariPlayer : null
                    fillMode: VideoOutput.PreserveAspectFit
                    visible: safariPlayer.playbackState === MediaPlayer.PlayingState
                             || safariPlayer.playbackState === MediaPlayer.PausedState
                }
