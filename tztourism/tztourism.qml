...
Rectangle {
    ...
    Rectangle {
                ...
                Column {
                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            Text {
                                anchors.centerIn: parent
                                text: safariTvOverlay.tvFullScreen ? "⛶" : "⛶"
                                font.pointSize: Qt.platform.os === "android" ? 14 : 11
                                color: "cyan"
                            }
                            MouseArea {
        ...
        // Shown only in fullscreen mode — video fills the entire overlay
        Item {
            id: fsLayer
            anchors.fill: parent
            visible: safariTvOverlay.tvFullScreen
            ...
            VideoOutput {
                ...
                Behavior on rotation { RotationAnimation { duration: 280; direction: RotationAnimation.Clockwise } }
            }
            ...
            // Tap anywhere to show/hide the floating controls bar
            MouseArea {
                anchors.fill: parent
            ...
            // ── LIVE badge (top-left, fullscreen) ──────────────────
            Rectangle {
                anchors.top: parent.top
                anchors.left: parent.left
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onReleased: {
                    ...
                    if (safariTvOverlay.tvFullScreen) {
                        safariTvOverlay.tvFullScreen = false;
                        fsLayer.videoRotation = 0;
                        return;
                    }
