...
Rectangle {
    ...
    property var bank4: [
        ...
        {w:"MWUA",sw:"Kufanya mtu apoteze uhai wake — jambo zito sana",en:"To kill"},
        ...
        {w:"PELA",sw:"Kupiga mbizi majini — au kusonga mbele bila kusimama",en:"To dive/push forward"},
        ...
        ,
        {w:"BAWU",sw:"Sauti ya nguruwe — au mtu anayepiga kelele bila sababu",en:"Grunt/Loud noise"},
        {w:"DOBE",sw:"Ardhi ya udongo laini inayotumiwa kutengeneza nyumba",en:"Adobe clay/Mud"},
        {w:"EMBU",sw:"Mji wa Kenya — au kabila lake maarufu",en:"Embu town/tribe Kenya"},
        ...
        {w:"BAWI",sw:"Tawi zito la mti — au mtu mwenye nguvu kubwa",en:"Heavy branch/Strong man"}
        ,
        ...
        {w:"BUNI",sw:"Ndege mkubwa asiyeruka — anakimbia haraka zaidi ya gari",en:"Ostrich chick"},
        {w:"TAYA",sw:"Sehemu ya mdomo ya mnyama inayosaidia kutafuna chakula",en:"Jaw/Mandible"},
        {w:"NZIO",sw:"Njia ya wanyama msituni — iliyofanywa kwa kupita mara nyingi",en:"Animal trail/Path"},
        ...
        {w:"RUVU",sw:"Mto wa Tanzania unaomwagika baharini — mto wa uhai",en:"Ruvu river Tanzania"},
        {w:"MARA",sw:"Mto wa Serengeti — wildebeest wavuke hapa kila mwaka",en:"Mara river"},
    ...
    property var bank5: [
        ...
        {w:"TRENI",sw:"Gari la reli — inaendelea bila kusimama ovyo barabarani",en:"Train"},
        ...
        {w:"TOCHI",sw:"Nuru ndogo unayobeba mkononi — giza linakimbia mbele yako",en:"Torch/Flashlight"},
        {w:"BETRI",sw:"Inahifadhi nguvu — lakini mwishowe inachoka kama sisi",en:"Battery"},
        ...
        {w:"KORAA",sw:"Kiumbe cha baharini kinachoundwa na viumbe vidogo sana",en:"Coral reef"},
        ...
        {w:"MAFIA",sw:"Kisiwa cha Tanzania — maarufu kwa matumbawe na samaki",en:"Mafia island"},
        {w:"GOMBE",sw:"Mbuga ya sokwe Tanzania — mahali pa Jane Goodall kazi",en:"Gombe national park"},
        {w:"RUAHA",sw:"Mbuga kubwa zaidi Tanzania — tembo wengi wanaishi hapa",en:"Ruaha national park"}
    ]
    ...
    property var bank6: [
        ...
        {w:"UVUNGU",sw:"Urefu wa mwitu — au mtu mrefu sana wa ajabu",en:"Tall person/Great height"},
        {w:"NANASI",sw:"Tunda lenye miiba nje — tamu ndani kama maisha ya kweli",en:"Pineapple"}
        ,
        {w:"ARUSHA",sw:"Mji wa utalii kaskazini Tanzania — mlango wa mbuga zote",en:"Arusha city"},
        {w:"DODOMA",sw:"Mji mkuu wa Tanzania — uliopo katikati ya nchi yote",en:"Dodoma capital"},
        {w:"MWANZA",sw:"Mji mkubwa wa pili Tanzania — kando ya Ziwa Victoria",en:"Mwanza city"},
        {w:"IRINGA",sw:"Mkoa wa milima Tanzania — wa baridi na mazao mazuri",en:"Iringa region"},
        {w:"TABORA",sw:"Mkoa wa kati Tanzania — wa historia ya biashara ya zamani",en:"Tabora region"},
        {w:"KIGOMA",sw:"Mkoa wa magharibi mwa Tanzania — kando ya Ziwa Tanganyika",en:"Kigoma region"},
        {w:"KATAVI",sw:"Mbuga ya kaskazini magharibi — ndovu wengi kuliko mbuga nyingi",en:"Katavi national park"},
        {w:"MAHALE",sw:"Mbuga ya sokwe Tanzania — karibu na Ziwa Tanganyika sana",en:"Mahale national park"},
        {w:"SELOUS",sw:"Hifadhi kubwa zaidi Afrika — sasa inaitwa Nyerere NP",en:"Selous/Nyerere NP"},
        {w:"CRATER",sw:"Korongo kubwa la volkano — Ngorongoro ni maarufu duniani",en:"Crater/Caldera"},
        {w:"BAOBAB",sw:"Mti mkubwa wa savanna Tanzania — unaoishi miaka elfu nyingi",en:""},
    ...
    property var bank7: [
        ...
        {w:"OLDUVAI",sw:"Korongo la historia ya binadamu — mifupa ya zamani kabisa",en:"Olduvai Gorge"},
        {w:"NYERERE",sw:"Baba wa Taifa — alianzisha utalii wa heshima Tanzania",en:"Julius Nyerere"},
        {w:"SAVANNA",sw:"Nyanda za majani Tanzania — makazi ya simba na twiga",en:"Savanna/Grassland"},
        {w:"NGURUMA",sw:"Ngurumo ya maporomoko ya maji — sauti inasikika mbali sana",en:"Roar of waterfalls"},
        {w:"UFUKOWE",sw:"Eneo la pwani la mchanga laini — watalii wanailalia jua",en:"Beach/Sandy shore"},
